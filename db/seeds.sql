...
INSERT INTO messages (sender_id, recipient_id, message_text, book_requested_id) VALUES
	(3, 2, 'I would like to meetup tuesday at 7 to exchange', 3),
    (2, 4, 'I would like to meet up wednesday', 2),
    (1, 4, 'I would like to meetup tuesday at 7 to exchange', 4),
    (4, 1, 'I would like to meet up wednesday', 4),
    (2, 1, 'I want your book please.  Meet me under the St. Clair bridge at dusk to make the exchange.', 1),
    (1, 2, 'I would like to meet up wednesday', 1),
    ...
    (2, 1, 'I would like to meetup tuesday at 7 to exchange', 1),
    (1, 2, 'I would like to meet up wednesday', 1),
    (3, 1, 'I would like to meetup tuesday at 7 to exchange', 1),
    (1, 3, 'I would like to meet up wednesday', 1),
    (3, 1, 'I would like to meetup tuesday at 7 to exchange', 1),
    (1, 3, 'I would like to meet up wednesday', 1),
    (3, 1, 'I would like to meetup tuesday at 7 to exchange', 1),
    (4, 1, 'I would like to meet up wednesday', 1),
    (1, 4, 'I would like to meetup tuesday at 7 to exchange', 1),
    (3, 4, 'I would like to meet up wednesday', 1),
    (2, 3, 'I would like to meetup tuesday at 7 to exchange', 1),
    (1, 2, 'I would like to meet up wednesday', 1);